...
const Option1 = (props) => {
  ...
  return (
    <section className="w-full h-screen bg-purple-200" id="education" style={{ fontFamily: 'sans-serif' }}>
      <div className="w-full px-4 md:px-32 pt-12 md:pt-24">
        <div
          className="w-full mt-10 md:mt-4 md:pl-24 pb-2 mb-2 md:mb-4 text-4xl border-b-2 border-purple-500"
          style={{ fontFamily: 'roboto', color: '#4B0082' }}
        >
          {educationTitle}
        </div>
        <div className="relative w-full mt-10 md:mt-8 flex flex-col gap-6">
          ...
          {education && education.map((item, index) => (
            <div
              key={index}
              className="relative w-[90vw] md:w-[70vw] p-6 rounded-lg shadow-lg bg-white text-gray-800"
            >
              <div>
                <div className="text-lg md:text-xl capitalize font-semibold mb-2 text-purple-800">
                ...
                <div className="flex justify-between items-center text-sm md:text-base">
                  ...
                  <div className="pr-2 capitalize text-purple-600" style={{ fontFamily: 'roboto' }}>
              ...
              <div
                className="absolute top-0 right-0 p-2 md:p-3 text-xs md:text-sm bg-purple-300 text-purple-900 rounded-bl-lg"
